...
// draw body along with clothing and goggles
void minionBody()
{
...
void Animate(void)
{
    //running animation (fast or slow)
    if (running)
    {
        if (runningAngle > 5)
            flag = -1;
...
void menuSelect(int value)
{
    ...
    switch (value)
    {
        case 1:
            running = GL_TRUE;
            speed = 2;//start the animation (walk)
